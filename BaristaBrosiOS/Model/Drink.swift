...
extension Drink {
    static var AllDrinks: [Drink] {
        [
            Drink(name: "Vodka Tonic", alcohols: ["Vodka" : 80], mixers: ["Tonic" : 140], calories: 183, rating: 4, ice: true, imageName: "VT"),
            Drink(name: "Gin & Tonic", alcohols: ["Gin" : 80], mixers: ["Tonic" : 140], calories: 125, rating: 4, ice: true, imageName: "GT"),
